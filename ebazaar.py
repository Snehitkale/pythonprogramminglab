...
if choices== "Furniture":
 ...
 msg11 ="available brands are"
    ...
    choices11 =["pepperfry-RS 9,500","nilkamal-RS 11,999","forzza-RS 15,999"]
 choice11 =choicebox(msg11,title11,choice11)
  
elif choice1=="Dining Tables":
 msg11 ="available brands are"
    title11 ="brand analysis"
    choices11 =["forzzo- RS 33,249","deckup- RS 30,999","royaloak- RS 32,249"]
 choice11 =choicebox(msg11,title11,choice11)
 
elif choice1== "Study Tables":
 msg11 ="available brands are"
    title11 ="brand analysis"
    choices11 =["deckup- RS 5,999","hometown- RS 8,999","royaloak- RS 7,500"]
 choice11 =choicebox(msg11,title11,choice11)
msgbox("you chose:" + "str(choice1)" +"of"+"str(choice11)")

elif choices== "Electronics":
 msg1 ="which electronics do you want?"
    title1 ="your choice"
    choices1 =["phone","laptop","speaker"]
 choice1 =choicebox(msg1,title1,choice1)
 
if choice1== "phone":
 msg11 ="available brands are"
    title11 ="phone brands"
    choices11 =["oneplus -RS 35,000","vivo -RS 24,000","mi redmi -RS 12,000"]
  choice11 =choicebox(msg11,title11,choice11)
  
elif choice1== "laptop":
 msg11 ="available brands are"
    title11 ="laptop brands"
    choices11 =["acer -RS 55,000","hp -RS 36,000","dell -RS 61,000"]
  choice11 =choicebox(msg11,title11,choice11)
   
elif choice1== "speaker":
 msg11 ="available brands are"
    title11 ="speaker brands"
    choices11 =["bosch -RS 10,000","i ball -RS 9000","skullcandy -RS 5000"]
  choice11 =choicebox(msg11,title11,choice11)
msgbox("you chose:" +"str(choice1)" +"of" + "str(choice11)")
       
elif choices== "Home Appliances":
